...
document.addEventListener("DOMContentLoaded", function () {
    $(".slide-1").slick({
        autoplay: true,
        autoplaySpeed: 2500,
        lazyLoad: "ondemand", // <-- extra optimization
        initialSlide: 0,
    });
    $(".product-slide-5").slick({
        ...
        speed: 300,
        slidesToShow: 5,
        lazyLoad: "ondemand", // Enable lazy loading for other slides
        slidesToScroll: 1,
        responsive: [
            {
                breakpoint: 1700,
...
(function ($) {
   ...
   ==========================*/
    $(".sm-nav-btn").on("click", function () {
        $(".nav-slide").css("right", "0px");
    });
    $(".nav-sm-back").on("click", function () {
        $(".nav-slide").css("right", "-410px");
    });
