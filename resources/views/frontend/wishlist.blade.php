            ...
            <div class="row">
                <div class="col">
                    <div class="breadcrumb-contain">
                        <div>
                            <h2> {{ __('frontend.wishlists.list') }} </h2>
                            <ul>
                                <li><a href="{{ route('frontend.dashboard') }}">  {{ __('frontend.about.dashboard') }} </a></li>
                                <li><i class="fa fa-angle-double-left"></i></li>
                                <li><a href="{{ route('frontend.wishlist') }}">  {{ __('frontend.wishlists.list') }} </a></li>
                            </ul>
                        </div>
                    </div>
                </div>
    ...
    <section class="wishlist-section section-big-py-space b-g-light">
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <table class="table cart-table table-responsive-xs">
                        <thead>
                            <tr class="table-head">
                                <th scope="col">{{ __('frontend.wishlists.photo') }} </th>
                                <th scope="col">{{ __('frontend.wishlists.product_name') }} </th>
                                <th scope="col">{{ __('frontend.wishlists.price') }} </th>
                                <th scope="col"></th>
                            </tr>
                        </thead>
                        <tbody>
            ...
            <div class="row wishlist-buttons">
                <div class="col-12"><a href="{{ route('frontend.search') }}" class="btn btn-normal"> {{ __('frontend.wishlists.shoping') }}  </a> <a
                        href="{{ route('frontend.cart') }}" class="btn btn-normal">    {{ __('frontend.wishlists.cart') }} </a></div>
            </div>
        </div>
    </section>
    <!--section end-->
