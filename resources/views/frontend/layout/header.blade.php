                ...
                <div class="main-menu-block">
                    <div class="header-left">
                        ...
                        <div class="brand-logo logo-sm-center">
                            <a href="{{ route('home') }}">
                                <img src="{{ $home_general_setting->logo->getUrl('thumb') }}" class="img-fluid" alt="logo">
                            </a>
                        </div>
                    </div>
                            ...
                            <form class="big-deal-form" action="{{route('frontend.search')}}">
                                <div class="input-group ">
                                    ...
                                    <select name="category">
                                        ...
                                        @foreach (\App\Models\HomeCategory::with('category')->get() as $homecategory)
                    ...
                    <div class="header-right">
                        <div class="icon-block">
                            <ul>
                                ...
                                <li class="mobile-cart item-count" @auth onclick="openCart()" @endauth>
                                    <a @guest href="{{ route('login') }}" @endguest>
                ...
                <div class="col-12">
                    <div class="navbar-menu">
                        <div class="logo-block">
                            <div class="brand-logo logo-sm-center">
                                <a href="{{ route('home') }}">
                                    <img src="{{ $home_general_setting->logo->getUrl('preview') }}" class="img-fluid"
                                        alt="logo">
                                </a>
                            </div>
                        </div>
                            ...
                            <nav id="main-nav">
                                ...
                                <ul id="main-menu" class="sm pixelstrap sm-horizontal">
                                    ...
                                    <li>
                                        ...
                                        <ul>
                                            @foreach (\App\Models\Category::with('sub_categories.sub_sub_categories')->get() as $category)
                                                <li>
                        ...
                        <div class="category-right">
                            <div class="contact-block">
                                <div>
                                    ...
                                    <span>call us <span>{{ $home_general_setting->phone_number }}</span></span>
                                </div>
                            </div>
                            <div class="btn-group">
