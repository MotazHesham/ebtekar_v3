                            ...
                            <form class="big-deal-form">
                                <div class="input-group ">
                                    ...
                                    <select>
                                        ...
                                        <option>المجات</option>
                                        <option>النوت بوك</option>
                                    </select>
                                </div>
                            </form>
                        </div>
                                ...
                                <div class="collapse  nav-desk" id="navbarToggleExternalContent">
                                    <ul class="nav-cat title-font">
                                        @foreach (\App\Models\HomeCategory::with('category')->get() as $homecategory)
                                            <li>
                                                <a href="category-page.html">{{ $homecategory->category->name ?? '' }}</a>
                                            </li>
                                        @endforeach
                                        <li>
                        ...
                        <div class="menu-block">
                            <nav id="main-nav">
                                ...
                                <ul id="main-menu" class="sm pixelstrap sm-horizontal">
                                    ...
                                    <li>
                                        <a class="dark-menu-item" href="beseller.html">أصبح تاجرا</a>
                                    </li>
                                    <li>

                                    <li>
                                        <a class="dark-menu-item" href="contactus.html"> تواصل معنا</a>
                                    </li>
                                    <li>
                                </ul>
                            </nav>
