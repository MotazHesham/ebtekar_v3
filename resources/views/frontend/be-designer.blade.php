                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="slider-content second-slider-content left-center">
                            ...
                            <h2 data-animation="fadeInUp" data-delay=".4s">EBTEKAR STORE <span>DESIGNERS</span></h2>
                    ...
                    <div class="col-12 pr-0">
                        <div class="testimonial-slide3 no-arrow"> 
                            @foreach($designers as $designer)
                                @php
                                    $image = $designer->user->photo ? $designer->user->photo->getUrl('preview') : '';
                                @endphp
                                <div>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        ...
                        @endif
                        <form action="{{ route('frontend.designer.register') }}" method="POST" class="contact-form">
                            @csrf
                            <div class="row">
                                <div class="col-lg-12">
                                ...
                                <div class="col-lg-12">
                                    <div class="contact-field p-relative c-subject mb-20" style="margin-bottom: 30px;">
                                        <input class="{{ $errors->has('store_name') ? ' is-invalid' : '' }}" type="text" placeholder="أسم المتجر" name="store_name" value="{{old('store_name')}}" required>
