<header class="c-header c-header-fixed px-3">
    ...
    <div class="d-md-down-none" style="width: 300px;padding: 14px 0px;">
    ...
    <ul class="c-header-nav @if (app()->getLocale() == 'ar') mr-auto @else ml-auto @endif">
        ...
        <ul class="c-header-nav ml-auto">
            <li class="c-header-nav-item dropdown notifications-menu">
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                    @if (count($alerts = \Auth::user()->userUserAlerts()->withPivot('read')->limit(10)->orderBy('created_at', 'DESC')->get()) > 0)
        ...
        <ul class="c-header-nav header-nav ">
            <li class="c-header-nav-item nav-item dropdown d-flex align-items-center">
                <a class="c-header-nav-link nav-link py-0 show" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
                    <div class="avatar avatar-md"> 
                        <i class="c-sidebar-nav-icon fa-fw fas fa-user">

                        </i>
                    </div>
                </a>
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right pt-0" style="position: absolute; inset: 0px 0px auto auto; margin: 0px; transform: translate(0px, 42px);">
        ...
        <button class="header-toggler px-md-0 me-md-3" type="button" onclick="aside()">
            <i class="c-sidebar-nav-icon fa-fw fab fa-blackberry">
