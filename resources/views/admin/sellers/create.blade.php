    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.sellers.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('seller_type') ? 'is-invalid' : '' }}" name="seller_type" id="seller_type" required>
                    ...
                    @foreach(App\Models\Seller::SELLER_TYPE_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('seller_type', 'seller') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('order_out_website') ? 'is-invalid' : '' }}" type="number" name="order_out_website" id="order_out_website" value="{{ old('order_out_website', '0') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('social_name') ? 'is-invalid' : '' }}" type="text" name="social_name" id="social_name" value="{{ old('social_name', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('social_link') ? 'is-invalid' : '' }}" type="text" name="social_link" id="social_link" value="{{ old('social_link', '') }}" required>
