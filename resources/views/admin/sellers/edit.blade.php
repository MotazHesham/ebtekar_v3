            ...
            <div class="row">
                <div class="form-group col-md-4">
                    ...
                    <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name"
                        id="name" value="{{ old('name', $seller->user->name) }}" required>
                    @if ($errors->has('name'))
                ...
                <div class="form-group col-md-4">
                    ...
                    <input class="form-control {{ $errors->has('phone_number') ? 'is-invalid' : '' }}" type="text"
                        name="phone_number" id="phone_number" value="{{ old('phone_number', $seller->user->phone_number) }}">
                ...
                <div class="form-group col-md-4">
                    ...
                    <input class="form-control {{ $errors->has('address') ? 'is-invalid' : '' }}" type="text" name="address" id="address" value="{{ old('address',$seller->user->address) }}">
