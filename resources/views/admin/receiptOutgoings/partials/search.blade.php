<div class="card">
    <div class="card-body"> 
        <b>{{ trans('global.search') }} {{ trans('cruds.receiptOutgoing.title') }}</b>
        <hr>
        <form action="" method="GET" id="sort_receipt_outgoing">
                    ...
                    <div class="row">
                        <div class="col-md-6"> 
                            <input type="text" class="form-control mb-2 @isset($client_name) isset @endisset" id="client_name" name="client_name"
                                @isset($client_name) value="{{ $client_name }}" @endisset placeholder="{{ trans('cruds.receiptOutgoing.fields.client_name') }}">  
                                
                            <input type="text" class="form-control mb-2 @isset($order_num) isset @endisset" id="order_num" name="order_num" 
                                @isset($order_num) value="{{ $order_num }}" @endisset placeholder="{{ trans('cruds.receiptOutgoing.fields.order_num') }}">  
                                    
                            <select class="form-control mb-2 @isset($staff_id) isset @endisset" name="staff_id" id="staff_id" onchange="sort_receipt_outgoing()">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control mb-2 @isset($phone) isset @endisset" id="phone" name="phone"
                                @isset($phone) value="{{ $phone }}" @endisset placeholder="{{ trans('cruds.receiptOutgoing.fields.phone_number') }}">
                            ...
                            <select class="form-control mb-2 @isset($done) isset @endisset" name="done" id="done" onchange="sort_receipt_outgoing()">
                                <option value="">{{ trans('cruds.receiptOutgoing.fields.done') }}</option>
            ...
            <div class="row">
                ...
                @endcan
                <div class="col-md-2">
                    <a class="btn btn-warning btn-rounded btn-block"  href="{{ route('admin.receipt-outgoings.index') }}">{{ trans('global.reset') }}</a>
                </div>
            </div> 
        </form>
