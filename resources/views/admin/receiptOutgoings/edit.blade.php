...
<div class="card">
    <div class="card-header">
        {{ __('global.edit') }} {{ __('cruds.receiptOutgoing.title_singular') }}
    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <textarea class="form-control {{ $errors->has('note') ? 'is-invalid' : '' }}" name="note" id="note" rows="8">{{ old('note', $receiptOutgoing->note) }}</textarea>
                        @if($errors->has('note'))
                            <div class="invalid-feedback">
                                {{ $errors->first('note') }}
                            </div>
