        ...
        <form action="" method="GET" id="sort_receipt_client">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <input type="text"
                                ...
                                placeholder="{{ trans('cruds.receiptClient.fields.client_name') }}">
                            <div class="row">
                                <div class="col-md-6">
                                    <input type="text"
                                ...
                                <div class="col-md-6">
                                    <input type="text"
                                        ...
                                        placeholder="{{ trans('cruds.receiptClient.fields.order_num') }}">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <select
                                        ...
                                        <option value="">{{ trans('cruds.receiptSocial.fields.deposit_type') }}
                                        </option>
                                ...
                                <div class="col-md-6">
                                    <select
                                        ...
                                        <option value="">
                                            {{ trans('cruds.receiptSocial.fields.financial_account_id') }}</option>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class=" text-center">
                                <span
                                    class="badge badge-light text-dark">{{ trans('global.extra.from_order') }}</span>
                                <input type="text"
                        ...
                        <div class="col-md-12 mt-2">
                            ...
                            <div class=" text-center" style="min-width: 160px; margin-bottom: 10px">
                                <span
                                    class="badge badge-light text-dark">{{ trans('global.extra.exclude_orders') }}</span>
                                <input type="text"
                        ...
                        <div class="col-md-12">
                            ...
                            <div class=" text-center" style="min-width: 160px; margin-bottom: 10px">
                                <span
                                    class="badge badge-light text-dark">{{ trans('global.extra.include_orders') }}</span>
                                <input type="text"
            ...
            <div class="row">
                ...
                @if (Gate::allows('download_receipts'))
                    <div class="col-md-2">
                        <input type="submit" value="{{ trans('global.download') }}" name="download"
                            class="btn btn-info btn-rounded btn-block">
                    </div>
                @endif
                @can('receipt_client_print')
                    <div class="col-md-2">
                        <input type="submit" value="{{ trans('global.print') }}" name="print"
                            class="btn btn-danger btn-rounded btn-block">
                    </div>
                @endcan
                <div class="col-md-2">
                    <a class="btn btn-warning btn-rounded btn-block"
                        href="{{ route('admin.receipt-clients.index') }}">{{ trans('global.reset') }}</a>
                </div>
            </div>
        </form>
