                ...
                <tbody>
                    ...
                    @forelse ($receipts as $receipt)
                        <tr data-entry-id="{{ $receipt->id }}"
                            @if ($receipt->quickly) style="background: linear-gradient(283deg,#ef8181 0%,#ffffff 18%);border: 1px red double;"  
                            @elseif($receipt->done)
                                style="background: linear-gradient(195deg,#000000bd 0%,#ffffff 33%);border: 1px black double;" @endif>
                            <td>
