...
<div class="card">
    <div class="card-header">
        {{ __('global.create') }} {{ __('cruds.homeCategory.title_singular') }}
    </div>
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.home-categories.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label class="required" for="category_id">{{ __('cruds.homeCategory.fields.category') }}</label>
                ...
                @endif
                <span class="help-block">{{ __('cruds.homeCategory.fields.category_helper') }}</span>
            </div>
            <div class="form-group">
