    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.zones.update", [$zone->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('delivery_cost_offer') ? 'is-invalid' : '' }}" type="number" name="delivery_cost_offer" id="delivery_cost_offer" value="{{ old('delivery_cost_offer', $zone->delivery_cost_offer) }}" required>
