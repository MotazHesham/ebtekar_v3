...
<div class="card">
    <div class="card-header">
        {{ __('global.create') }} {{ __('cruds.expense.title_singular') }}
    </div>
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.expenses.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="expense_category_id">{{ __('cruds.expense.fields.expense_category') }}</label>
                ...
                @endif
                <span class="help-block">{{ __('cruds.expense.fields.expense_category_helper') }}</span>
            </div>
            <div class="form-group">
                <label class="required" for="entry_date">{{ __('cruds.expense.fields.entry_date') }}</label>
