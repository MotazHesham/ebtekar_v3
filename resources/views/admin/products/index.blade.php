                    ...
                    <form action="{{ route('admin.products.edit_prices') }}" method="POST">
                        ...
                        <div class="row"> 
                            <div class="form-group col-md-4">
                                <label class="">{{ trans('cruds.product.fields.category') }}</label>
                            ...
                            <div class="form-group col-md-4">
                                <label class="">{{ trans('cruds.product.fields.sub_category') }}</label>
                                <select class="form-control  {{ $errors->has('sub_category') ? 'is-invalid' : '' }}" name="sub_category" id="sub_category">
                                    <option value disabled {{ old('sub_category', null) === null ? 'selected' : '' }}>{{ trans('global.pleaseSelect') }}</option>
                            ...
                            <div class="form-group col-md-4">
                                <label class="">{{ trans('cruds.product.fields.sub_sub_category') }}</label>
                                <select class="form-control  {{ $errors->has('sub_sub_category') ? 'is-invalid' : '' }}" name="sub_sub_category" id="sub_sub_category">
                                    <option value disabled {{ old('sub_sub_category', null) === null ? 'selected' : '' }}>{{ trans('global.pleaseSelect') }}</option>
