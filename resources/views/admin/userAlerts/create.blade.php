    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.user-alerts.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label class="required" for="alert_text">{{ __('cruds.userAlert.fields.alert_text') }}</label>
                ...
                @endif
                <span class="help-block">{{ __('cruds.userAlert.fields.alert_text_helper') }}</span>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label for="users">{{ __('cruds.userAlert.fields.user') }}</label>
