...
<div class="card">
    <div class="card-header">
        {{ __('global.edit') }} {{ __('cruds.season.title_singular') }}
    </div>
        ...
        <form method="POST" action="{{ route('admin.seasons.update', [$season->id]) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text"
                    name="name" id="name" value="{{ old('name', $season->name) }}" required>
                @if($errors->has('name'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('year') ? 'is-invalid' : '' }}" type="number"
                    name="year" id="year" value="{{ old('year', $season->year) }}" min="2000" max="2100" required>
                @if($errors->has('year'))
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('start_date') ? 'is-invalid' : '' }}" type="text"
                    name="start_date" id="start_date" value="{{ old('start_date', $season->start_date) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('end_date') ? 'is-invalid' : '' }}" type="text"
                    name="end_date" id="end_date" value="{{ old('end_date', $season->end_date) }}" required>
