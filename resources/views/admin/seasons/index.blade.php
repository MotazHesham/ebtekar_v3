    ...
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.seasons.create') }}">
                {{ __('global.add') }} {{ __('cruds.season.title_singular') }}
            </a>
        </div>
    </div>
@endcan
<div class="card">
    <div class="card-header">
        {{ __('cruds.season.title') }} {{ __('global.list') }}
    </div>

    <div class="card-body">
        <table class="table table-bordered table-striped table-hover ajaxTable datatable datatable-Season">
            <thead>
                <tr>
                    <th width="10"></th>
...
<script>
    $(function () {
        ...
        let dtOverrideGlobals = {
            ...
            retrieve: true,
            aaSorting: [],
            ajax: "{{ route('admin.seasons.index') }}",
            columns: [
        ...
        $('.datatable-Season').DataTable(dtOverrideGlobals);
