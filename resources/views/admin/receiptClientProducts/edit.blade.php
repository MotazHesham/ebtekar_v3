...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.receiptClientProduct.title_singular') }}
    </div>
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.receipt-client-products.update", [$receiptClientProduct->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('price_parts') ? 'is-invalid' : '' }}" type="number" name="price_parts" id="price_parts" value="{{ old('price_parts', $receiptClientProduct->price_parts) }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('price_permissions') ? 'is-invalid' : '' }}" type="number" name="price_permissions" id="price_permissions" value="{{ old('price_permissions', $receiptClientProduct->price_permissions) }}" step="0.01" required>
