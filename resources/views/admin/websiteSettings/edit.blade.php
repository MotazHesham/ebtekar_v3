        ...
        <div class="card-body">
            <form method="POST" action="{{ route('admin.website-settings.update', [$websiteSetting->id]) }}"
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-4">
                        <label class="required" for="keywords_seo">{{ trans('cruds.websiteSetting.fields.keywords_seo') }}</label>
                    ...
                    <div class="form-group col-md-4">
                        <label class="required" for="author_seo">{{ trans('cruds.websiteSetting.fields.author_seo') }}</label>
                    ...
                    <div class="form-group col-md-4">
                        <label class="required" for="sitemap_link_seo">{{ trans('cruds.websiteSetting.fields.sitemap_link_seo') }}</label>
                    ...
                    <div class="form-group col-md-4">
                        <label class="required" for="description_seo">{{ trans('cruds.websiteSetting.fields.description_seo') }}</label>
