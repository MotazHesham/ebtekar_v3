...
<div class="modal-content">
    ...
    <div class="modal-body">
        <form action="{{ route('admin.receipt-price-views.add_product') }}" method="POST" enctype="multipart/form-data">
            @csrf  
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="description" step="1" min="1" required placeholder="{{ trans('global.extra.description') }}" required>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        <label for="">{{ trans('global.extra.price') }}</label>
                        <input class="form-control" type="number" name="price" step="1" min="1" required placeholder="{{ trans('global.extra.price') }}" required>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
