...
@section('content')
@can('excel_file_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.excel-files.create') }}">
                {{ trans('global.add') }} {{ trans('cruds.excelFile.title_singular') }}
            </a>
        </div>
    </div>
@endcan
<div class="card">
    <div class="card-header">
        {{ trans('cruds.excelFile.title_singular') }} {{ trans('global.list') }}
    </div>
...
@can('excel_file_delete')
  let deleteButtonTrans = '{{ trans('global.datatables.delete') }}';
  let deleteButton = {
    text: deleteButtonTrans,
    url: "{{ route('admin.excel-files.massDestroy') }}",
...
{ data: 'id', name: 'id' },
{ data: 'type', name: 'type' },
{ data: 'uploaded_file', name: 'uploaded_file', sortable: false, searchable: false },
{ data: 'result_file', name: 'result_file', sortable: false, searchable: false },
