...
<div class="card">
    <div class="card-header">
        {{ __('global.edit') }} {{ __('cruds.currency.title_singular') }}
    </div>
        ...
        <form method="POST" action="{{ route("admin.currencies.update", [$currency->id]) }}" enctype="multipart/form-data">
            ...
            <div class="row"> 
                ...
                <div class="form-group col-md-2">
                    ...
                    @endif
                    <span class="help-block">{{ __('cruds.currency.fields.half_kg_helper') }}</span>
                </div>
                <div class="form-group col-md-2">
                    ...
                    @endif
                    <span class="help-block">{{ __('cruds.currency.fields.one_kg_helper') }}</span>
                </div>
                <div class="form-group col-md-2">
                    ...
                    @endif
                    <span class="help-block">{{ __('cruds.currency.fields.one_half_kg_helper') }}</span>
                </div>
                <div class="form-group col-md-2">
                    ...
                    @endif
                    <span class="help-block">{{ __('cruds.currency.fields.two_kg_helper') }}</span>
                </div>
                <div class="form-group col-md-2">
                    ...
                    @endif
                    <span class="help-block">{{ __('cruds.currency.fields.two_half_kg_helper') }}</span>
                </div>
                <div class="form-group col-md-2">
                    ...
                    @endif
                    <span class="help-block">{{ __('cruds.currency.fields.three_kg_helper') }}</span>
                </div>
