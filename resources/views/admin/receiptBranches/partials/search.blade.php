    ...
    <div class="card-body"> 
        <form action="" method="GET" id="sort_receipt_branch">
            ...
            <div style="display: flex;justify-content: space-between;">
                <div>
                    <b>{{ __('global.search') }} {{ __('cruds.receiptBranch.title') }}</b>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-6"> 
                            <input type="text" class="form-control mb-2 @isset($client_name) isset @endisset" id="client_name" name="client_name"
                                @isset($client_name) value="{{ $client_name }}" @endisset placeholder="{{ __('cruds.receiptBranch.fields.client_name') }}">  
                                
                            <input type="text" class="form-control mb-2 @isset($order_num) isset @endisset" id="order_num" name="order_num" 
                                @isset($order_num) value="{{ $order_num }}" @endisset placeholder="{{ __('cruds.receiptBranch.fields.order_num') }}">  
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control mb-2 @isset($phone) isset @endisset" id="phone" name="phone"
                                @isset($phone) value="{{ $phone }}" @endisset placeholder="{{ __('cruds.receiptBranch.fields.phone_number') }}">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <select class="form-control mb-2 @isset($done) isset @endisset" name="done" id="done" onchange="sort_receipt_branch()">
                                        <option value="">{{ __('cruds.receiptBranch.fields.done') }}</option>
            ...
            <div class="row">
                ...
                @endcan
                <div class="col-md-2">
                    <a class="btn btn-warning btn-rounded btn-block"  href="{{ route('admin.receipt-branches.index') }}">{{ __('global.reset') }}</a>
                </div>
            </div> 
        </form>
