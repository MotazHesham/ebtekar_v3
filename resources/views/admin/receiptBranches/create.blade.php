...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.receiptBranch.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.receipt-branches.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="row">
                ...
                <div class="form-group col-md-4">
                    <label class="required" for="r_client_id">{{ trans('cruds.receiptBranch.fields.r_client_id') }}</label>
                    <select class="form-control select2 {{ $errors->has('r_client_id') ? 'is-invalid' : '' }}" name="r_client_id" id="r_client_id" required onchange="branches()">
                        @foreach($rclients as $id => $entry)
                            <option value="{{ $id }}" {{ old('r_client_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                        @endforeach
                    </select>
                ...
                <div class="form-group col-md-4" > 
                    <label class="required" for="r_branch_id">{{ trans('cruds.receiptBranch.fields.r_branch_id') }}</label>
                ...
                <div class="form-group col-md-4">
                    <label for="date_of_receiving_order">{{ trans('cruds.receiptBranch.fields.date_of_receiving_order') }}</label>
                    ...
                    @endif
                    <span class="help-block">{{ trans('cruds.receiptBranch.fields.date_of_receiving_order_helper') }}</span>
                </div>  
                <div class="form-group col-md-4">
                    <label for="deposit">{{ trans('cruds.receiptBranch.fields.deposit') }}</label>
                    ...
                    @endif
                    <span class="help-block">{{ trans('cruds.receiptBranch.fields.deposit_helper') }}</span>
                </div>
                <div class="form-group col-md-4">
                    <label for="discount">{{ trans('cruds.receiptBranch.fields.discount') }}</label>
                    ...
                    @endif
                    <span class="help-block">{{ trans('cruds.receiptBranch.fields.discount_helper') }}</span>
                </div>
                <div class="form-group col-md-6">
                    <label for="note">{{ trans('cruds.receiptBranch.fields.note') }}</label>
                    ...
                    @endif
                    <span class="help-block">{{ trans('cruds.receiptBranch.fields.note_helper') }}</span>
                </div> 
