@if (Gate::allows('statistics_receipts'))
    ...
    <div class="modern-stats-dashboard" id="modernStatsDashboard">
            ...
            <div class="stats-overview">
                ...
                <div class="stat-card info">
                    ...
                    <div class="stat-content">
                        ...
                        <small>( العمولة + المنتجات - الخصم )</small>
                    </div>
                </div>
                ...
                <div class="stat-card warning">
                    ...
                    <div class="stat-content">
                        <h3>{{ dashboard_currency(number_format(round($statistics['total_total_cost_without_deposit']))) }}
                        </h3>
                        <p>المجموع بدون العربون</p>
                        <small>( المنتجات + العمولة - الخصم - العربون )</small>
                    </div>
                </div>
                ...
                <div class="stat-card danger">
                    ...
                    <div class="stat-content">
                        <h3>{{ dashboard_currency(number_format(round($statistics['total_shipping_country_cost']))) }}
                        </h3>
                        <p>إجمالي الشحن</p>
                    </div>
                </div>
                ...
                <div class="stat-card dark">
                    ...
                    <div class="stat-content">
                        ...
                        <p>المجموع الصافي</p>
                        <small>( المنتجات + العمولة - الخصم - العربون + الشحن )</small>
                    </div>
                </div>
            </div>
            ...
            <div class="quick-actions">
                ...
                <div class="action-card">
                    ...
                    <div class="action-content">
                        ...
                        <a href="{{ route('admin.receipt-socials.index', ['new_design' => false]) }}"
        ...
        <div class="modal fade" id="customerChartModal" tabindex="-1" aria-labelledby="customerChartModalLabel"
            aria-hidden="true">
