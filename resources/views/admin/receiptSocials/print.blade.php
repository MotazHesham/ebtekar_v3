...
<body>
        ...
        <div style="page-break-after: always;">
            <div style="padding: 1.5rem;postition:relative">
                ...
                <table>
                    <tr>
                        <td>
                            <img src="{{ asset($site_settings->logo->getUrl()) }}" height="130"
                ...
                <div style="position: absolute;right:120px;top:65px;font-size:40px">
                    ...
                    @php
                        ...
                        echo '<img src="data:image/png;base64,' .
                            DNS1D::getBarcodePNG($bar_code, config('app.barcode_type')) .
                            '" alt="barcode"   />';
                    @endphp
            ...
            <div style="position:relative">
                <table class="table table-bordered text-center" style="width:380px;position:absolute;right:10px;top:0"
                    id="price-{{ $receipt->id }}">
                    <thead>
                        <td>عدد القطع</td>
                        <td>المطلوب دفعه</td>
                ...
                <table class="table table-bordered text-center" style="width:380px;position:absolute;left:10px;top:0"
                ...
                <table class="table table-bordered text-center"
                    style="width:380px;position:absolute;top:100px;right:10px" id="client_info-{{ $receipt->id }}">
                    <tbody>
                        <tr>
                        ...
                        <tr>
                            <td>{{ $receipt->phone_number }} @if ($receipt->phone_number_2)
                ...
                <table class="table table-bordered text-center">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                {{ $receipt->phone_number }} @if ($receipt->phone_number_2)
                                    - {{ $receipt->phone_number_2 }}
                                @endif
                            </td>
                            <td colspan="2">
    ...
    <script>
        ...
        @foreach ($receipts as $key => $receipt)
            var price_and_client_info = $('#price-{{ $receipt->id }}').height() + $('#client_info-{{ $receipt->id }}')
                .height() + 50;
