...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.receipt-socials.update", [$receiptSocial->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="client_name">{{ trans('cruds.receiptSocial.fields.client_name') }}</label>
                <input class="form-control {{ $errors->has('client_name') ? 'is-invalid' : '' }}" type="text" name="client_name" id="client_name" value="{{ old('client_name', $receiptSocial->client_name) }}" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('client_type') ? 'is-invalid' : '' }}" name="client_type" id="client_type" required>
                    ...
                    @foreach(App\Models\ReceiptSocial::CLIENT_TYPE_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('client_type', $receiptSocial->client_type) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('phone_number') ? 'is-invalid' : '' }}" type="text" name="phone_number" id="phone_number" value="{{ old('phone_number', $receiptSocial->phone_number) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('phone_number_2') ? 'is-invalid' : '' }}" type="text" name="phone_number_2" id="phone_number_2" value="{{ old('phone_number_2', $receiptSocial->phone_number_2) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('deposit') ? 'is-invalid' : '' }}" type="number" name="deposit" id="deposit" value="{{ old('deposit', $receiptSocial->deposit) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('discount') ? 'is-invalid' : '' }}" type="number" name="discount" id="discount" value="{{ old('discount', $receiptSocial->discount) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('commission') ? 'is-invalid' : '' }}" type="number" name="commission" id="commission" value="{{ old('commission', $receiptSocial->commission) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('extra_commission') ? 'is-invalid' : '' }}" type="number" name="extra_commission" id="extra_commission" value="{{ old('extra_commission', $receiptSocial->extra_commission) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total_cost') ? 'is-invalid' : '' }}" type="number" name="total_cost" id="total_cost" value="{{ old('total_cost', $receiptSocial->total_cost) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('shipping_country_name') ? 'is-invalid' : '' }}" type="text" name="shipping_country_name" id="shipping_country_name" value="{{ old('shipping_country_name', $receiptSocial->shipping_country_name) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('shipping_country_cost') ? 'is-invalid' : '' }}" type="number" name="shipping_country_cost" id="shipping_country_cost" value="{{ old('shipping_country_cost', $receiptSocial->shipping_country_cost) }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('shipping_address') ? 'is-invalid' : '' }}" name="shipping_address" id="shipping_address" required>{{ old('shipping_address', $receiptSocial->shipping_address) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('date_of_receiving_order') ? 'is-invalid' : '' }}" type="text" name="date_of_receiving_order" id="date_of_receiving_order" value="{{ old('date_of_receiving_order', $receiptSocial->date_of_receiving_order) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('deliver_date') ? 'is-invalid' : '' }}" type="text" name="deliver_date" id="deliver_date" value="{{ old('deliver_date', $receiptSocial->deliver_date) }}">
            ...
            <div class="form-group">
                <label for="cancel_reason">{{ trans('cruds.receiptSocial.fields.cancel_reason') }}</label>
                <textarea class="form-control {{ $errors->has('cancel_reason') ? 'is-invalid' : '' }}" name="cancel_reason" id="cancel_reason">{{ old('cancel_reason', $receiptSocial->cancel_reason) }}</textarea>
                @if($errors->has('cancel_reason'))
                    <div class="invalid-feedback">
                        {{ $errors->first('cancel_reason') }}
                    </div>
                @endif
                <span class="help-block">{{ trans('cruds.receiptSocial.fields.cancel_reason_helper') }}</span>
            </div>
            <div class="form-group">
                <label for="delay_reason">{{ trans('cruds.receiptSocial.fields.delay_reason') }}</label>
                <textarea class="form-control {{ $errors->has('delay_reason') ? 'is-invalid' : '' }}" name="delay_reason" id="delay_reason">{{ old('delay_reason', $receiptSocial->delay_reason) }}</textarea>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('delivery_status') ? 'is-invalid' : '' }}" name="delivery_status" id="delivery_status" required>
                    ...
                    @foreach(App\Models\ReceiptSocial::DELIVERY_STATUS_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('delivery_status', $receiptSocial->delivery_status) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('note') ? 'is-invalid' : '' }}" name="note" id="note">{{ old('note', $receiptSocial->note) }}</textarea>
                @if($errors->has('note'))
                    <div class="invalid-feedback">
                        {{ $errors->first('note') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('payment_status') ? 'is-invalid' : '' }}" name="payment_status" id="payment_status" required>
                    ...
                    @foreach(App\Models\ReceiptSocial::PAYMENT_STATUS_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('payment_status', $receiptSocial->payment_status) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('playlist_status') ? 'is-invalid' : '' }}" name="playlist_status" id="playlist_status" required>
                    ...
                    @foreach(App\Models\ReceiptSocial::PLAYLIST_STATUS_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('playlist_status', $receiptSocial->playlist_status) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('staff') ? 'is-invalid' : '' }}" name="staff_id" id="staff_id" required>
                    @foreach($staff as $id => $entry)
                        <option value="{{ $id }}" {{ (old('staff_id') ? old('staff_id') : $receiptSocial->staff->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
                @if($errors->has('staff'))
                    <div class="invalid-feedback">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('shipping_country') ? 'is-invalid' : '' }}" name="shipping_country_id" id="shipping_country_id" required>
                    @foreach($shipping_countries as $id => $entry)
                        <option value="{{ $id }}" {{ (old('shipping_country_id') ? old('shipping_country_id') : $receiptSocial->shipping_country->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('socials') ? 'is-invalid' : '' }}" name="socials[]" id="socials" multiple>
                    @foreach($socials as $id => $social)
                        <option value="{{ $id }}" {{ (in_array($id, old('socials', [])) || $receiptSocial->socials->contains($id)) ? 'selected' : '' }}>{{ $social }}</option>
                    @endforeach
                </select>
