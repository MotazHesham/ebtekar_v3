    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.general-settings.update", [$generalSetting->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('site_name') ? 'is-invalid' : '' }}" type="text" name="site_name" id="site_name" value="{{ old('site_name', $generalSetting->site_name) }}" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('address') ? 'is-invalid' : '' }}" name="address" id="address">{{ old('address', $generalSetting->address) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}" name="description" id="description">{{ old('description', $generalSetting->description) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('phone_number') ? 'is-invalid' : '' }}" type="text" name="phone_number" id="phone_number" value="{{ old('phone_number', $generalSetting->phone_number) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" type="email" name="email" id="email" value="{{ old('email', $generalSetting->email) }}">
                @if($errors->has('email'))
                    <div class="invalid-feedback">
                        {{ $errors->first('email') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('facebook') ? 'is-invalid' : '' }}" type="text" name="facebook" id="facebook" value="{{ old('facebook', $generalSetting->facebook) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('instagram') ? 'is-invalid' : '' }}" type="text" name="instagram" id="instagram" value="{{ old('instagram', $generalSetting->instagram) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('twitter') ? 'is-invalid' : '' }}" type="text" name="twitter" id="twitter" value="{{ old('twitter', $generalSetting->twitter) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('telegram') ? 'is-invalid' : '' }}" type="text" name="telegram" id="telegram" value="{{ old('telegram', $generalSetting->telegram) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('linkedin') ? 'is-invalid' : '' }}" type="text" name="linkedin" id="linkedin" value="{{ old('linkedin', $generalSetting->linkedin) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('whatsapp') ? 'is-invalid' : '' }}" type="text" name="whatsapp" id="whatsapp" value="{{ old('whatsapp', $generalSetting->whatsapp) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('youtube') ? 'is-invalid' : '' }}" type="text" name="youtube" id="youtube" value="{{ old('youtube', $generalSetting->youtube) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('google_plus') ? 'is-invalid' : '' }}" type="text" name="google_plus" id="google_plus" value="{{ old('google_plus', $generalSetting->google_plus) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('welcome_message') ? 'is-invalid' : '' }}" name="welcome_message" id="welcome_message">{{ old('welcome_message', $generalSetting->welcome_message) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('video_instructions') ? 'is-invalid' : '' }}" type="text" name="video_instructions" id="video_instructions" value="{{ old('video_instructions', $generalSetting->video_instructions) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('delivery_system') ? 'is-invalid' : '' }}" name="delivery_system" id="delivery_system">
                    ...
                    @foreach(App\Models\GeneralSetting::DELIVERY_SYSTEM_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('delivery_system', $generalSetting->delivery_system) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('designer') ? 'is-invalid' : '' }}" name="designer_id" id="designer_id">
                    @foreach($designers as $id => $entry)
                        <option value="{{ $id }}" {{ (old('designer_id') ? old('designer_id') : $generalSetting->designer->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('preparer') ? 'is-invalid' : '' }}" name="preparer_id" id="preparer_id">
                    @foreach($preparers as $id => $entry)
                        <option value="{{ $id }}" {{ (old('preparer_id') ? old('preparer_id') : $generalSetting->preparer->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('manufacturer') ? 'is-invalid' : '' }}" name="manufacturer_id" id="manufacturer_id">
                    @foreach($manufacturers as $id => $entry)
                        <option value="{{ $id }}" {{ (old('manufacturer_id') ? old('manufacturer_id') : $generalSetting->manufacturer->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('shipment') ? 'is-invalid' : '' }}" name="shipment_id" id="shipment_id">
                    @foreach($shipments as $id => $entry)
                        <option value="{{ $id }}" {{ (old('shipment_id') ? old('shipment_id') : $generalSetting->shipment->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
