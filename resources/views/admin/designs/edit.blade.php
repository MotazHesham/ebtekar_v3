...
<div class="card">
    <div class="card-header">
        {{ __('global.edit') }} {{ __('cruds.design.title_singular') }}
    </div>
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.designs.update", [$design->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="cancel_reason">{{ __('cruds.design.fields.cancel_reason') }}</label>
                ...
                @endif
                <span class="help-block">{{ __('cruds.design.fields.cancel_reason_helper') }}</span>
            </div>
            <div class="form-group">
