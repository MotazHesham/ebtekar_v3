...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.seoSetting.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.seo-settings.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label class="required" for="keyword">{{ trans('cruds.seoSetting.fields.keyword') }}</label>
                <input class="form-control {{ $errors->has('keyword') ? 'is-invalid' : '' }}" type="text" name="keyword[]" id="keyword"  placeholder="add tags ..." data-role="tagsinput" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sitremap_link') ? 'is-invalid' : '' }}" type="text" name="sitremap_link" id="sitremap_link" value="{{ old('sitremap_link', '') }}" required>
