...
class GlobalSearchController extends Controller
{
    private $models = [
        ...
        'ReceiptSocial'        => 'cruds.receiptSocial.title',
        'ReceiptSocialProduct' => 'cruds.receiptSocialProduct.title',
        'ReceiptClient'        => 'cruds.receiptClient.title',
        'ReceiptClientProduct' => 'cruds.receiptClientProduct.title',
        'ReceiptCompany'       => 'cruds.receiptCompany.title',
        'Seller'               => 'cruds.seller.title',
        'Category'             => 'cruds.category.title',
        'Order'                => 'cruds.order.title',
        'ReceiptOutgoing'      => 'cruds.receiptOutgoing.title',
        'ReceiptPriceView'     => 'cruds.receiptPriceView.title',
        'Product'              => 'cruds.product.title',
        'Designer'             => 'cruds.designer.title',
    ];
