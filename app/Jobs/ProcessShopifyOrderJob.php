...
class ProcessShopifyOrderJob implements ShouldQueue
{
    ...
    public function handle(): void
    {
        ...
        try {
            ...
            $country = Country::where('shopify_name', $shipping_address['province'])->first();
            $is_new_order = false;
            if (!$receiptSocial) {
            ...
            if($receiptSocial->ad_history_id){
                RecalculateAdsAccountHistory::dispatch($receiptSocial->ad_history_id);
            }
