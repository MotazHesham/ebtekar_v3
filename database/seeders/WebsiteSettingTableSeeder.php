    ...
    public function run(): void
    {
        ...
        $websites = [
            [ 
                ...
                'description_seo' => 'FiguresStore',
                'keywords_seo' => 'Gifts,Giveaways,هدايا,دعايا واعلان,ليزر ,نوت بوك ,بوكسات,ميداليات ,ميداليات طباعه ,مجات ,كوسترات ,هدايا المولد النبوي,هدايا عيد الفطر ,هدايا عيد الاضحي ,هدايا رأس السنه ,هدايا رمضان ,هدايا عيد الام ,هدايا الخطوبه ,علبه شبكه للخطوبه اوالفرح,طباعه,هدايا عيد الح ,اباجورات اكليرك ,اباجورات خشب ,تابلوهات ,طقم مكتب ,استاند اسم ,دعايا شركات ,ديكورات ,دروع ,عرايس ,منظم مكتب ,دلاية عربية ,افكار سبوع اطفال ,استاندات ,العاب اطفال ,خشب ,مطبوعات ,اقلام مطبوعه ,كروت شخصيه ,ابتكار ,ebtekar ,ابتكار ستور ,ebtekar store,تقطيع خشب ,حفر خشب ,هدايا شركات ,هدية عيد ميلاد ,هدايا اعياد ميلاد ,علب هدايا ,فوانيس ,هدايا رمضانية ,فانوس,ميداليه',
            ...
            [ 
                ...
                'description_seo' => 'ShirteStore',
                'keywords_seo' => 'Gifts,Giveaways,هدايا,دعايا واعلان,ليزر ,نوت بوك ,بوكسات,ميداليات ,ميداليات طباعه ,مجات ,كوسترات ,هدايا المولد النبوي,هدايا عيد الفطر ,هدايا عيد الاضحي ,هدايا رأس السنه ,هدايا رمضان ,هدايا عيد الام ,هدايا الخطوبه ,علبه شبكه للخطوبه اوالفرح,طباعه,هدايا عيد الح ,اباجورات اكليرك ,اباجورات خشب ,تابلوهات ,طقم مكتب ,استاند اسم ,دعايا شركات ,ديكورات ,دروع ,عرايس ,منظم مكتب ,دلاية عربية ,افكار سبوع اطفال ,استاندات ,العاب اطفال ,خشب ,مطبوعات ,اقلام مطبوعه ,كروت شخصيه ,ابتكار ,ebtekar ,ابتكار ستور ,ebtekar store,تقطيع خشب ,حفر خشب ,هدايا شركات ,هدية عيد ميلاد ,هدايا اعياد ميلاد ,علب هدايا ,فوانيس ,هدايا رمضانية ,فانوس,ميداليه',
                'author_seo' => 'ShirteStore',
                'sitemap_link_seo' => 'example.com',
                'address' => 'وسط البلد',
                'description' => 'أفكار مبتنتهيش ❤️',
                'phone_number' => '01000586206',
                'email' => 'support@shirtestore.net',
                ...
                'youtube' => 'https://www.youtube.com/channel/UCdc3TF6fHfe95TUyE4xt-Pg',
                'google_plus' => 'https://google.com',
                'welcome_message' => 'Hello , Welcome to ShirteStore',
                'video_instructions' => 'https://www.youtube.com/watch?v=RrZ7hcjYUxM',
                'delivery_system' => 'ebtekar',
                'borrow_password' => '123123',
                'designer_id' => 1,
