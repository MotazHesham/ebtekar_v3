...
return new class extends Migration
{
    ...
    { 
        return 'CREATE VIEW view_playlist_data AS
                ...
                rs.shipmenter_id,rs.delivery_man_id,rs.note,rs.send_to_playlist_date,rs.send_to_delivery_date,rs.quickly,rs.printing_times,rs.website_setting_id,rs.hold,rs.created_at,rs.updated_at,rs.deleted_at,
                ...
                shipmenter_id,delivery_man_id,note,send_to_playlist_date,send_to_delivery_date,quickly,printing_times,CONCAT(0) AS website_setting_id,CONCAT(0) AS hold,created_at,updated_at,deleted_at,description
                ...
                ords.shipmenter_id,ords.delivery_man_id,ords.note,ords.send_to_playlist_date,ords.send_to_delivery_date,ords.quickly,ords.printing_times,ords.website_setting_id,CONCAT(0) AS hold,ords.created_at,ords.updated_at,ords.deleted_at,
