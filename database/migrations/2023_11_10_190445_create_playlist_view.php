...
return new class extends Migration
{
    ...
    { 
        return 'CREATE VIEW view_playlist_data AS
                ...
                delivery_status,rs.payment_status,rs.playlist_status,rs.delay_reason,rs.cancel_reason,rs.designer_id,rs.preparer_id,rs.manufacturer_id,rs.staff_id as added_by,is_seasoned,rs.returned_to_design,
                ...
                delivery_status,payment_status,playlist_status,delay_reason,cancel_reason,designer_id,preparer_id,manufacturer_id,staff_id As added_by,CONCAT(0) AS is_seasoned,CONCAT(0) AS returned_to_design,
                ...
                ords.delivery_status,ords.payment_status,ords.playlist_status,ords.delay_reason,ords.cancel_reason,ords.designer_id,ords.preparer_id,ords.manufacturer_id,ords.user_id As added_by,CONCAT(0) AS is_seasoned,CONCAT(0) AS returned_to_design,
